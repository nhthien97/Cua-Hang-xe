...
public class HeThongQuanLy {
    ...
    public HeThongQuanLy() {
        ...
        center.themXe(new Car("A001", "Civic 2024", "Honda", MauSac.TRANG, 850_000_000, "civic2024.svg"));
        center.themXe(new Car("A002", "CR-V 2024", "Honda", MauSac.DEN, 1_100_000_000, "crv2024.svg"));

        PhongBan sales = new PhongBan("Honda Vietnam", "Việt Nam", "Miền Bắc", "Honda Center Hà Nội", "Hà Nội", "Bán Hàng");
        sales.getDanhSachXe().add(new Car("A003", "City 2024", "Honda", MauSac.BAC, 560_000_000, "city2024.svg"));
        npp.add(sales);

        CuaHangUyNhiem hcm = new CuaHangUyNhiem("Honda Vietnam", "Việt Nam", "Miền Nam", "Honda Quận 7", "TP. HCM");
        hcm.themXe(new Car("B101", "HR-V 2024", "Honda", MauSac.DO, 899_000_000, "hrv2024.svg"));
        authorized.add(hcm);
        npp.add(hcm);

        ChiNhanhDiaPhuong hcmA = new ChiNhanhDiaPhuong("Honda Vietnam", "Việt Nam", "Miền Nam", "Honda Quận 7 - Cơ sở A", "Quận 7", "Tân Phong");
        hcmA.getDanhSachXe().add(new Car("B102", "City 2024", "Honda", MauSac.XANH, 560_000_000, "city2024.svg"));
        branches.add(hcmA);
        npp.add(hcmA);

        CuaHangUyNhiem dn = new CuaHangUyNhiem("Honda Vietnam", "Việt Nam", "Miền Trung", "Honda Đà Nẵng", "Đà Nẵng");
        dn.themXe(new Car("C201", "CR-V 2024", "Honda", MauSac.TRANG, 1_100_000_000, "crv2024.svg"));
        authorized.add(dn);
        npp.add(dn);
    }
